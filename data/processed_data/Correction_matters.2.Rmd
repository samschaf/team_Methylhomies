...
- none of these are in our data set


_____
treat normalization like a treatment and do linear regression between the two?

D

QN, QN + cell corrected, QN + BMIQ, QN + BMIQ + cell type